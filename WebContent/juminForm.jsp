...
<!-- 
	...
	넘겨주고 return 값이 false면 현재 페이지에 그대로 머물러 있게 한다.
-->
...
<form action="juminFormOK.jsp" method="post" name="juminForm" onsubmit="return formCheck(this)">
	...
	<input type="text" name="j1" maxlength="6" placeholder="주민번호 앞 6자리" size="11" onkeyup="moveNext(this, 6, document.juminForm.j2)">
	-
	<input type="text" name="j2" maxlength="7" placeholder="주민번호 뒷 7자리" size="11" onkeyup="moveNext(this, 7, document.juminForm.sendBtn)">
